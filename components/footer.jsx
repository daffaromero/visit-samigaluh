    ...
    <div className='bg-gray-950 px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen md:px-24 lg:px-8'>
      <div className='grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4'>
        ...
        <div>
          ...
          <div className='flex items-center mt-1 space-x-3'>
            <Link
              href='https://twitter.com/kknugmsamigaluh'
          ...
          <p className='mt-4 text-sm text-gray-500'>
            KKN-PPM UGM adalah program pengabdian masyarakat yang dilaksanakan
            oleh mahasiswa Universitas Gadjah Mada (UGM) selama 50 hari di
            seluruh Indonesia.
          </p>
        </div>
      </div>
      <div className='flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row'>
        <p className='text-sm text-gray-600'>
          © Copyright 2023 KKN-PPM UGM Samigaluh. All rights reserved.
        </p>
